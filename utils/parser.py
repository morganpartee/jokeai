...
def parameter_parser():
    ...
    parser.add_argument(
        "--learning_rate", dest="learning_rate", type=float, default=0.01
    )
    ...
    parser.add_argument(
        "--model", dest="model", type=str, default="weights/textGenerator.pt"
    )
    parser.add_argument("--data", dest="data_file", type=str)
